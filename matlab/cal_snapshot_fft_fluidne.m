...
% ylabel('$$\sqrt{\left \langle \delta{ A_{\parallel}}^2 \right \rangle}$$','Interpreter','latex','fontsize',16);
% ylabel('$(a.u.)$','Interpreter','latex','fontsize',16);
title('$\delta n_{e, rms}$','Interpreter','latex','fontsize',16);
grid on
...
xlabel('$r/a$','interpreter','latex','fontsize',16);
% ylabel('$$\delta{ A_{\parallel}}$$','Interpreter','latex','fontsize',16);
% ylabel('$(a.u.)$','Interpreter','latex','fontsize',16);
title('$\delta n_{e}(r,\theta=0,\zeta=0)$','Interpreter','latex','fontsize',16);
grid on
% legend(legend_str00,'Interpreter','latex','fontsize',16);
...
%diag_m = mmodes; %设置5个点较为合适
diag_m = m_mpsimax+[-3:1:3]; %设置7个点较为合适 曲线区分度明显
...
title('$\delta\widetilde{n}_{e, m}(\psi_p)$','Interpreter','latex','fontsize',16);
grid on
legend(legend_str)
%% 使用归一化的坐标 绘制上图
figure(277)
...
xlabel('$r/a$','interpreter','latex','fontsize',16);
ylabel('$Amplitude$','Interpreter','latex','fontsize',16);
title('$\delta\widetilde{n}_{e, m}(r)$','Interpreter','latex','fontsize',16);
grid on
legend(legend_str2)
%% 多个径向位置mpsi叠加在一张图上
% subplot(2,2,1)
...
ylabel('$Amplitude$','Interpreter','latex','fontsize',16);
title(['poloidal spectra ','$ \delta\widetilde{n}_{e, m}(r)$'],'Interpreter','latex','fontsize',16);
...
title(['$m(\delta\widetilde{n}_{e, \; max},\psi_p)$',' diag flux = ',num2str(diag_flux)],'Interpreter','latex','fontsize',16);
grid on
subplot(2,2,3)
...
xlabel('$mpsi$','Interpreter','latex','fontsize',16);
ylabel('$Amplitude$','Interpreter','latex','fontsize',16);
% title(['$ \delta \delta A_{m}(\psi_p)$',' max mpsi = ',num2str(mpsi_iflux(max_iflux))],'Interpreter','latex','fontsize',16);
title(['$\delta\widetilde{n}_{e, \; max}(\psi_p)$',' max mpsi = ',num2str(mpsi_iflux(max_iflux))],'Interpreter','latex','fontsize',16);
grid on
subplot(2,2,2)
...
ylabel('$k_\theta [m^{-1}]$','interpreter','latex','fontsize',16)
title('$\delta\widetilde{n}_{e}$','Interpreter','latex','fontsize',16);
%% 二维contour图
figure(2772)
...
% plot(x(:,diag_flux),y(:,diag_flux),'--k','linewidth',1);
% title('$ A_{\parallel}$','interpreter','latex','fontsize',20)
