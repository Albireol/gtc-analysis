...
title('$\delta A_{\parallel rms}$','Interpreter','latex','fontsize',16);
grid on
...
% ylabel('$(a.u.)$','Interpreter','latex','fontsize',16);
title('$\delta A_{\parallel}(r,\theta=0,\zeta=0)$','Interpreter','latex','fontsize',16);
grid on
% legend(legend_str00,'Interpreter','latex','fontsize',16);
...
title('$\delta\widetilde{A}_{\parallel m}(\psi_p)$','Interpreter','latex','fontsize',16);
grid on
legend(legend_str)
%% 使用归一化的坐标 绘制上图
figure(227)
...
ylabel('$Amplitude$','Interpreter','latex','fontsize',16);
title(['poloidal spectra ','$ \delta\widetilde{A}_{\parallel m}(r)$'],'Interpreter','latex','fontsize',16);
...
title(['$m(\delta\widetilde{A}_{\parallel max},\psi_p)$',' diag flux = ',num2str(diag_flux)],'Interpreter','latex','fontsize',16);
grid on
subplot(2,2,3)
...
title(['$\delta\widetilde{A}_{\parallel max}(\psi_p)$',' max mpsi = ',num2str(mpsi_iflux(max_iflux))],'Interpreter','latex','fontsize',16);
grid on
subplot(2,2,2)
...
title('$\delta\widetilde{A}_{\parallel}$','Interpreter','latex','fontsize',16);
%% 二维contour图
figure(2272)
